...
export const fetchLessons = () => dispatch => {
  ...
  return axios
    .get(`${process.env.API_URL}/lessons`)
    .then(({ data }) => dispatch(receiveLessons(data)), err => error());
};
...
export const fetchLesson = data => dispatch => {
  ...
  return axios
    .get(`${process.env.API_URL}/lessons/${data}`)
    .then(({ data }) => dispatch(receiveLesson(data)), err => error());
};
...
export const createLesson = data => dispatch => {
  ...
  return axios
    .post(`${process.env.API_URL}/lessons/create`, data)
    .then(({ data }) => dispatch(receiveCreateLesson(data)), err => error());
};
...
export const updateLesson = data => dispatch => {
  ...
  return axios
    .post(`${process.env.API_URL}/lessons/update`, data)
    .then(({ data }) => dispatch(receiveUpdateLesson(data)), err => error());
};
...
export const deleteLesson = data => dispatch => {
  ...
  return axios
    .post(`${process.env.API_URL}/lessons/delete`, data)
    .then(() => dispatch(receiveDeleteLesson(data)), err => error());
};
